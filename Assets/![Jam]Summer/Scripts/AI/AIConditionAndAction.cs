...
public class CountCardTypeCondition : AICondition
{
    ...
    public override bool IsMet(EnemyMaster enemyMaster)
    {
        return GridMaster.instant.GetCountType(IsEnemy ? !enemyMaster.Team : enemyMaster.Team, Card) >= CountMin;
    }
}
[Serializable]
public class CountCardInSquareCondition : AICondition
{
    ...
    public override bool IsMet(EnemyMaster enemyMaster)
    {
        return GridMaster.instant.GetCountTypeInSquare<CardEntity>(point1, point2, IsEnemy ? !enemyMaster.Team : enemyMaster.Team) >= CountMin;
    }
}
